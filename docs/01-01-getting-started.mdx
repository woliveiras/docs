...
slug: /
---
import {RaguWebsiteLoader} from "../examples/ragu-website/Loader";

Ragu aims to deliver a simple and coupleless way to organize your front-end
into micro-frontends through front-end injection.
...
Have you ever looked at the Ragu's homepage code? There are multiple front-ends injected
